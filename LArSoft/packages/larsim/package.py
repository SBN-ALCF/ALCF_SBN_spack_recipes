...
class Larsim(CMakePackage, FnalGithubPackage):
    ...
    version("10.04.00", sha256="96bb0c265631cbac56583aafea5a8a20d3bc8ba2de7deac356ff7053f6e3cc36") # FIXME
    version("10.02.02", sha256="e6d72ea1a54a876022e16bd4371e883fdefeb391b7e1233d38baa59e1807994e")
    ...
    def setup_run_environment(self, env):
        ...
        env.prepend_path("CMAKE_MODULE_PATH", self.prefix.lib.larsim.cmake)
